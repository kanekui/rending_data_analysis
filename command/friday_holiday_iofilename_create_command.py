...
class FridayHolidayIOfilenameCreateCommand(IExecutable):
    def execute(self, dto: RendingDataSet) -> RendingDataSet:
        ...
        if weekday == 1:  # 火曜日の場合
            ...
            dto.pdf_file_path = current_folder_path + "\\" + f'syumatsu2023{seven_days_ago_str}00.pdf'
            dto.pdf_file_url = f'https://www.jpx.co.jp/markets/statistics-equities/margin/tvdivq0000001rnl-att/syumatsu2023{seven_days_ago_str}00.pdf'
            dto.nisshokyo_file_path = current_folder_path + "\\" + f'2023{seven_days_ago_str}z.xls'
            dto.nisshokyo_file_url = f'https://www.jsda.or.jp/shiryoshitsu/toukei/kabu-taiw/files/2023{seven_days_ago_str}z.xls'
